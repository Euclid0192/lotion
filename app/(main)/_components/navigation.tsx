...
const Navigation = () => {
  ...
  const sidebarRef =
    useRef<ComponentRef<"aside">>(null);
  const navbarRef =
    useRef<ComponentRef<"div">>(null);
  ...
  const handleMouseMove = (
    ...
    newWidth = Math.min(480, newWidth);
    ...
    if (
      ...
      // Keep the navbar in sync with the sidebar
  ...
  return (
    <>
      ...
      {/* All the logic is to keep the navbar in sync with sidebar collapse state */}
      <div
        ref={navbarRef}
        className={cn(
